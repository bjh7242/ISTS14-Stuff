...
@app.route("/")
def hello():
    return 'Welcome To Bank of SPARSA<br />You can buy many things with the money you make being a bank. Be sure to keep your services up so that you can make money! Each check is worth $7812.5 and 8 services are monitored for potential $62500 per round. Rounds are undertaken every 5 minutes. Remember that your power bill is due once per hour and cost $300,000. If you have extra funds, please take a look below at the wide verity of offerings we provide.<br><br><iframe style="appearance:none;outline:none;-moz-appearance:none;-webkit-appearance:none;" border=0 width=100% height=100% src="http://bankapi.whiteteam.ists/ProductGridLayout/"></iframe>'
